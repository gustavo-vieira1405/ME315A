...
cAA + pal + ggtitle("Atrasos - American Airlines (AA)")
cDL + pal + ggtitle("Atrasos - Delta Air Lines (DL)")
cUA + pal + ggtitle("Atrasos - United Airlines (UA)")
cUS + pal + ggtitle("Atrasos - US Airways (US)")
```
